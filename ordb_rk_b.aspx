...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            var q_name = 'view_ordbs',
                t_bbsTag = 'tbbs',
                t_content = " field=productno,product,spec,dime,width,lengthb,radius,mount,weight,noa,no3,price,total,theory,memo,kind,style,class,uno,size,unit,unit2,source order=odate ",
                afilter = [],
                bbsKey = ['noa', 'no3'],
                t_count = 0,
                as;
            //,acoin,afloata,amemo
            var t_sqlname = 'ordbs_load2';
            t_postname = q_name;
            brwCount2 = 12;
            var isBott = false;
            var txtfield = [],
		...
		<div  id="dFixedTitle" style="overflow-y: scroll;">
			<table id="tFixedTitle" class='tFixedTitle'  border="2"  cellpadding='2' cellspacing='1' style='width:100%'  >
				<tr style='color:White; background:#003366;' >
					...
					<td align="center" id='FixedSize'><a id='lblSize'></a>
					<BR>
		...
		<div id="dbbs" style="overflow: scroll;height:550px;" >
			<table id="tbbs" class='tbbs'	border="2"	cellpadding='2' cellspacing='1' style='width:100%'	>
				...
				<tr style='background:#cad3ff;'>
					...
					<td id="FixedSize">
					<input class="txt num c8" id="txtSize1.*" type="text"/>
					<div id="x1" style="float: left">
						x
					</div>
					<input class="txt num c8" id="txtSize2.*" type="text"/>
					<div id="x2" style="float: left">
						x
					</div>
					<input class="txt num c8" id="txtSize3.*" type="text"/>
					...
					<input class="txt c1" id="txtNo3.*" type="text" />
					</td>
					<td>
